        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			...
			<div class="panel panel-default">
			  ...
			  <div class="panel-body">
				<form action="${APP_PATH}/role/update.do" method="post" role="form">
				  <input type="hidden" name="id" value="${role.id }">
				  <div class="form-group">
					<label for="frolename">角色名称</label>
					<input type="text" class="form-control" value="${role.name }" name="name" id="fname" placeholder="请输入角色名称">
				  </div>
