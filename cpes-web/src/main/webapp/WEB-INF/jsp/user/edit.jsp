			  ...
			  <div class="panel-body">
				<form role="form">
				  <div class="form-group">
					...
					<input type="text" class="form-control" id="floginacct" value="${user.loginacct }" placeholder="请输入登录帐号">
				  ...
				  <div class="form-group">
					...
					<input type="text" class="form-control" id="femail" value="${user.email }" placeholder="请输入邮箱地址">
				  </div>
				<%--   <div class="form-group">
